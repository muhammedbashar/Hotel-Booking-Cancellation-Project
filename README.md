...
* A higher Average Daily Rate (ADR) is strongly associated with higher cancellation levels.

* August has the highest number of bookings and cancellations, while January shows the highest relative cancellations.

* Online Travel Agencies account for ~47% of bookings and a similar share of cancellations.
